...
config.keys = {
  ...
  { key = 'd', mods = 'CMD', action = action.SplitHorizontal { domain = 'CurrentPaneDomain', cwd = wezterm.home_dir } },
  { key = 'd', mods = 'CMD|SHIFT', action = action.SplitVertical { domain = 'CurrentPaneDomain', cwd = wezterm.home_dir } },
